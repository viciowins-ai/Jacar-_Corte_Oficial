...
export function TermsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F2F2F2] pb-24">
      ...
      <div className="p-4 flex-1">
        <div className="bg-white rounded-2xl shadow-sm p-6 space-y-6 text-sm text-gray-600">
          <div>
            <h3 className="font-bold text-gray-900 mb-1 text-base">Aceitação dos Termos</h3>
            <p className="text-xs leading-relaxed text-justify">
              Ao utilizar o aplicativo Jacaré do Corte, você concorda com estes Termos de Uso e com todas as regras aplicáveis.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-gray-900 mb-1 text-base">Agendamentos & Cancelamentos</h3>
            <p className="text-xs leading-relaxed text-justify">
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-1 text-base">Conta do Usuário</h3>
            <p className="text-xs leading-relaxed text-justify">
